...
<body id="body">
	<div class="wrapper" style="padding-left: 25%;padding-right: 25%;">
		<div class="wrapper__middle">
			...
			<div class="">
				<p class="mb-0">При оплате вашего заказа <b>№<?php echo $_REQUEST['order_id']; ?></b> произошла ошибка.<br><br> <?php echo $res_arr['resultMessage']; ?>. Попробуйте совершить попытку оплаты ещё раз, убедитесь в достоверности введенных вами данных.</p>
			</div>
		</div>
	</div>
